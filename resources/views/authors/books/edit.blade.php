                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            @endif
                            <div id="cover-upload-area" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border border-gray-300 border-dashed rounded-md">
                        ...
                        <div>
                            ...
                            @if($book->file_path)
                                <div class="mt-2 mb-4 p-3 bg-green-50 border border-green-200 rounded-md">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-sm text-green-800">File e-book tersedia</span>
                                    </div>
                                    <p class="mt-1 text-xs text-green-600">{{ basename($book->file_path) }}</p>
                                </div>
                            @else
                                <div class="mt-2 mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-yellow-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
                                        </svg>
                                        <span class="text-sm text-yellow-800">Belum ada file e-book</span>
                                    </div>
                                </div>
                            @endif
                            <div id="ebook-upload-area" class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border border-gray-300 border-dashed rounded-md">
                                <div class="space-y-1 text-center">
                                    {{-- Loading Indicator --}}
