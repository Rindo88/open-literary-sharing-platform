                            ...
                            <li class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="mt-1 flex items-center text-sm text-gray-500">
                                                ...
                                                @foreach ($book->category_names as $name)
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('books.show', ['type' => 'books', 'id' => $book->id]) }}"
                                            target="_blank"
                                        ...
                                        <a href="{{ route('authors.books.edit', $book) }}"
                                            class="inline-flex items-center px-3 py-1 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="{{ route('authors.books.destroy', $book) }}" method="POST"
                                            class="inline"
