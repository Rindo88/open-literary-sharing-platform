                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @auth
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative">
                                <button type="button"
                                    class="flex items-center space-x-3 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-full p-1"
                                    id="user-menu-button">
                                    ...
                                    @else
                                        <div
                                            class="profile-photo h-9 w-9 rounded-full bg-blue-600 flex items-center justify-center">
                                            <span
                                ...
                                <div class="hidden origin-top-right absolute right-0 mt-2 w-56 rounded-xl shadow-lg dropdown-menu ring-1 ring-black ring-opacity-5 focus:outline-none z-50"
                                    id="user-menu">
                                    <div class="py-2">
                ...
                <div class="md:hidden flex items-center space-x-2">
                    <button type="button"
                        ...
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            id="mobile-menu-icon">
                            <path class="hamburger-line" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M4 6h16"></path>
                            <path class="hamburger-line" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M4 12h16"></path>
                            <path class="hamburger-line" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M4 18h16"></path>
                        </svg>
                    </button>
                </div>
            </div>
                    ...
                    @auth
                        <div class="border-t border-gray-100 pt-4 mt-4">
                            <div class="flex items-center px-4 py-3">
                                ...
                                @else
                                    <div
                                        class="profile-photo h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center">
                                        <span
                                            class="text-white text-sm font-medium">{{ substr(auth()->user()->name, 0, 1) }}</span>
                                    </div>
                                @endif
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="mt-2">
                                @csrf
                                <button type="submit"
                                    class="flex items-center w-full px-4 py-3 rounded-xl text-sm text-red-600 hover:bg-red-50 transition-all duration-200 mobile-menu-item">
