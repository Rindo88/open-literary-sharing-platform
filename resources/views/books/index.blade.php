        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            @auth
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('books.my-books') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                        Buku Saya
                    </a>
                </div>
            @endauth
                ...
                @foreach($books as $book)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600 mb-2">oleh {{ $book->author }}</p>
                            ...
                            <div class="flex space-x-2">
                                ...
                                @auth
                                    <form method="POST" action="{{ route('books.add-to-wishlist', $book) }}" class="flex-1">
                                        @csrf
                                        <button type="submit" 
