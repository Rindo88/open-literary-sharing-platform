            ...
            <div class="bg-white rounded-lg shadow p-4 sm:p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-lg sm:text-xl font-semibold text-gray-900">{{ $averageRating ?: 'Belum ada rating' }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                <div class="p-4 sm:p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="ml-3 text-lg sm:text-xl font-semibold text-gray-900">Panel Penulis</h3>
                    </div>
                    <p class="text-sm sm:text-base text-gray-600 mb-4">
                        Publish/tulis karya Anda sekarang dengan menjadi author dan bagikan cerita kepada pembaca
                    </p>
            ...
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                <div class="p-4 sm:p-6">
                    ...
                    <p class="text-sm sm:text-base text-gray-600 mb-4">
                        Kelola koleksi buku bacaan pribadi dan track progress membaca
                    </p>
            ...
            @if (Auth::user()->role === 'admin')
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                    <div class="p-4 sm:p-6">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
                        <div class="p-4 sm:p-6">
                                            ...
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if ($i <= $book->average_rating)
                                                    <svg class="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path
                                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.118 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                                        </path>
                                                    </svg>
                                                @else
                            ...
                            <div class="flex space-x-2">
                                ...
                                @else
                                    <span
                                        class="flex-1 inline-flex items-center justify-center px-3 py-2 border border-gray-300 text-xs font-medium rounded-md text-gray-400 bg-gray-100 cursor-not-allowed">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                ...
                                @if (Auth::check() && isset($book->id) && $book->id)
                                    ...
                                    @if (!$userBook)
                                        <form action="{{ route('books.start-reading', $book) }}" method="POST"
                                            class="flex-1">
                                            @csrf
                                            <button type="submit"
                                    ...
                                    @else
                                        <span
                                            class="flex-1 inline-flex items-center justify-center px-3 py-2 border border-gray-200 text-xs font-medium rounded-md text-gray-500 bg-gray-100">
